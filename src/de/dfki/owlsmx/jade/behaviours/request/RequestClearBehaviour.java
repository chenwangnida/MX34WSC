 ...
 */
public class RequestClearBehaviour extends SimpleAchieveREInitiator {
     ...
     */
    public RequestClearBehaviour(Agent myAgent, AID matchmakerAgent) {
        super(myAgent, null);
    ...
    protected ACLMessage prepareRequest(ACLMessage message) {
        ...
        Action action = new Action(matchmakerAgent, clear);
